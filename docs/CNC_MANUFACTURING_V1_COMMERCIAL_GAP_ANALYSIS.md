...
**Audit date:** 2026-09-08. CNC-V1-07R (commercial CMMS release closure) and CNC-V1-08R (canonical OEE and operations cockpit) are release-verified. CNC-V1-08R evidence includes the isolated 50-machine benchmark and full backup/restore rehearsal.
...
**CNC-V1-09R — planned-versus-actual costing.** CNC-V1-08R's OEE release gates are closed. The next commercial product gap is released material/rate inputs, planned and actual work-order/operation/unit cost, variance, scrap/rework policy and missing-data controls.
