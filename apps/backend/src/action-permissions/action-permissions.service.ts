...
export const HMI_ACTIONS = ["HMI_READ", "HMI_START", "HMI_COMPLETE", "HMI_SETUP", "HMI_PAUSE", "HMI_RESUME", "HMI_HOLD", "HMI_HOLD_RELEASE", "HMI_REPORT", "HMI_REWORK"] as const;
export const MRP_ACTIONS = ["MRP_READ", "MRP_RUN", "MRP_FIRM", "MRP_CONVERT_MAKE", "MRP_CONVERT_BUY", "MRP_ADMIN_PARAMETERS"] as const;
export const CMMS_ACTIONS = ["CMMS_READ", "CMMS_REQUEST_CREATE", "CMMS_BREAKDOWN_DECLARE", "CMMS_WO_PLAN", "CMMS_WO_EXECUTE", "CMMS_ASSIGN_TECHNICIAN", "CMMS_SPARE_ISSUE", "CMMS_PM_ADMIN", "CMMS_RETURN_TO_SERVICE", "CMMS_CODE_ADMIN"] as const;
export const OEE_ACTIONS = ["OEE_READ", "OEE_LOSS_REASON_ADMIN"] as const;
export const COSTING_ACTIONS = ["COSTING_READ", "COSTING_RATE_ADMIN"] as const;
export const ACTION_PERMISSION_ACTIONS = [...TOOLING_ACTIONS, ...HMI_ACTIONS, ...MRP_ACTIONS, ...CMMS_ACTIONS, ...OEE_ACTIONS, ...COSTING_ACTIONS] as const;
